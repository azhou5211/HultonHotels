...
try {
	...
	String newBType = request.getParameter("BType");
	int newHotelID = 0;
	...
	String insert = "INSERT INTO buyBreakfast(CID,HotelID ,BType)"
			+ "VALUES (?,?,?)";
	...
	ps.setString(3, newBType);
	//Run the query against the DB
	//System.out.println(newCountry);
	//System.out.println(ps);
	ps.executeUpdate();
			
	out.print("Your breakfast order has been submitted! Press button to reload to page.");
} catch (Exception ex) {
	out.print("Your breakfast order has failed please make sure you entered in the correct information, refer to PDF!");
}
%>
