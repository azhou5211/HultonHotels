...
try {
	...
	String passw = "SELECT ReviewID as RID FROM Review WHERE RType = 'Room' and Typess = '" + newType + "' and Rating = " + newRating + " and TextComment = '" + newTextComment + "'";
	...
	out.print("Review has been submitted! Press button to reload to login/registration page.");
} catch (Exception ex) {
	out.print("Your room review has failed please make sure you entered in the correct information, refer to PDF!");
}
%>
