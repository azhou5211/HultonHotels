...
try {
	...
	if (entity.equals("room")) {
		str = "SELECT t.HotelID, t.RoomType, max(t.Rating/t.n) Rating FROM (SELECT r.HotelID,r.ReviewID,r.Rating,r.Typess RoomType,count(r.Typess) n FROM HotelSchema.Review r WHERE r.RType = 'Room' and r.RDate >= "+ newInDate + " and r.RDate <= " + newOutDate + ") t GROUP BY t.HotelID and t.RoomType";
	System.out.println(str);
	}
	if (entity.equals("customer")) {
		
		}
	if (entity.equals("breakfast")) {
