...
try {
	...
	String passw = "SELECT ReviewID as RID FROM Review WHERE RType = 'Service' and Typess = '" + newType + "' and Rating = " + newRating + " and TextComment = '" + newTextComment + "'";
	...
	out.print("Your service review has failed please make sure you entered in the correct information, refer to PDF!");
}
%>
